...
- Do not place business translation texts inside `@hj-fe/locales` to better manage business and general translation texts.
...
With `@hj-fe/locales`, you can easily use translation texts:
